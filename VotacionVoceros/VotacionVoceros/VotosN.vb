...
Public Class VotosN
    ...
    Private Sub VotosN_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        Else
            ...
            ContVotosN.VotosNocheTableAdapter.SumN1()
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        Else
            YaVotaron.YaVotadosTableAdapter.Insertar(Docvottext.Text)
            ContVotosN.VotosNocheTableAdapter.SumN2()
            MsgBox("GRACIAS POR VOTAR")
            Button2.Enabled = False
            Button3.Enabled = False
            Button4.Enabled = False
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        ...
        Else
            YaVotaron.YaVotadosTableAdapter.Insertar(Docvottext.Text)
            ContVotosN.VotosNocheTableAdapter.SumN3()
            MsgBox("GRACIAS POR VOTAR")
            Button2.Enabled = False
            Button3.Enabled = False
            Button4.Enabled = False
    ...
    Private Sub Button5_Click(sender As Object, e As EventArgs) Handles Button5.Click
        ...
        Else
            YaVotaron.YaVotadosTableAdapter.Insertar(Docvottext.Text)
            ContVotosN.VotosNocheTableAdapter.SumVBN()
            MsgBox("GRACIAS POR VOTAR")
            Button2.Enabled = False
            Button3.Enabled = False
            Button4.Enabled = False
