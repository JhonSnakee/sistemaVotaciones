        ...
        If File.Exists(ruta & archivo) Then
            Try
                ...
                While leer.Peek <> -1
                    ...
                    VotosN.PictureBox2.Image = Image.FromFile(linea)
        ...
        If File.Exists(ruta2 & archivo2) Then
            Try
                ...
                While leer.Peek <> -1
                    ...
                    ':::Agregramos los registros encontrados
                    'Aplicamos la imagen actual
                    VotosN.PictureBox3.Image = Image.FromFile(linea)
        ...
        If File.Exists(ruta3 & archivo3) Then
            Try
                ...
                While leer.Peek <> -1
                    ...
                    ':::Agregramos los registros encontrados
                    'Aplicamos la imagen actual
                    VotosN.PictureBox4.Image = Image.FromFile(linea)
        ...
        If CargarImagenes.ShowDialog() = DialogResult.OK Then
            ...
            Try
                If File.Exists(ruta) Then
                    ...
                    'Aplicamos la imagen actual
                    VotosN.PictureBox2.Image = Image.FromFile(Path.GetFullPath(CargarImagenes.FileName))
        ...
        If CargarImagenes.ShowDialog() = DialogResult.OK Then
            ...
            Try
                If File.Exists(ruta2) Then
                    ...
                    'Aplicamos la imagen actual
                    VotosN.PictureBox3.Image = Image.FromFile(Path.GetFullPath(CargarImagenes.FileName))
        ...
        If CargarImagenes.ShowDialog() = DialogResult.OK Then
            ...
            Try
                If File.Exists(ruta3) Then
                    ...
                    'Aplicamos la imagen actual
                    VotosN.PictureBox4.Image = Image.FromFile(Path.GetFullPath(CargarImagenes.FileName))
